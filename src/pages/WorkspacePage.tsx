...
import { 
  Files, Search, GitBranch, Settings, User, Bug, PlayCircle, Code2, Monitor, 
  Info, Check, AlertCircle, FileCode, FileJson, FilePlus, FolderPlus, RefreshCw, 
  MoreVertical, Layout, PanelLeft, PanelBottom, Sidebar, Home, BarChart2, Briefcase, 
  ListTodo, Github as GithubIcon, MessageSquare as ChatIcon, Bell, HelpCircle
} from "lucide-react";
